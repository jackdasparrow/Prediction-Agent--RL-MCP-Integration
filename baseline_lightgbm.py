...
# Fix for "I/O operation on closed file" in Windows
import sys

# Force reset stdout / stderr to the original console handles
...
class BaselineLightGBM:
    ...
    def _get_feature_columns(self, df: pd.DataFrame) -> List[str]:
        ...
        if removed:
            logger.warning(f"Dropped non-numeric features: {removed}")
...
if __name__ == "__main__":
    logging.basicConfig(
        ...
        stream=sys.__stdout__   # 👈 Force logs to real stdout
    )
    main()
