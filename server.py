...
@app.post("/tools/feedback", response_model=MCPResponse, tags=["Training"])
async def feedback(
...
@app.post("/tools/train_rl", response_model=MCPResponse, tags=["Training"])
async def train_rl(
...
@app.post("/tools/fetch_data", response_model=MCPResponse, tags=["Data"])
